...
document.getElementById('nuevaCategoriaForm').addEventListener('submit', (e) => {
  e.preventDefault();
  this.saveCategoria();
});

document.getElementById('guardarCategoriaEditBtn').addEventListener('click', () => {
  this.saveEditCategoria();
});

document.getElementById('categoriasModal').addEventListener('shown.bs.modal', () => {
  this.loadCategorias();
});
