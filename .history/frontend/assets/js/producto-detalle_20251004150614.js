...
class ProductoDetalle {
  ...
  renderStock() {
    ...
    // Solo mostrar stock si mostrar_stock es true
    if (p.mostrar_stock === false) {
      container.innerHTML = ""; // Ocultar completamente el contenedor
      return;
    }
...
async function loadTikTokPreview() {
  ...
  try {
    // Llamar directamente a la API de TikTok desde el navegador
